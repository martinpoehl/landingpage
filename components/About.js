        ...
        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div class="col-span-4 sm:col-span-3">
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex flex-col items-center">
                        <img src="/assets/me.jpg" class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">

                        </img>
                        <h1 class="text-xl font-bold">Martin Pöhl</h1>
                        <p class="text-gray-700">Webdeveloper, System Engeener</p>
            ...
            <div class="col-span-4 sm:col-span-9">
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <h2 class="text-xl font-bold mt-6 mb-4">Erfahrung</h2>
                    <div class="mb-6">
